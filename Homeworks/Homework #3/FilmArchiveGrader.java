...
public class FilmArchiveGrader 
{
	...
	{
		Movie alfie1 = new Movie("Alfie", 1966);
		Movie alfie2 = new Movie("Alfie", 1966);
		Movie gb1 = new Movie("Ghostbusters", 1984);
		Movie gb2 = new Movie("Ghostbusters", 2016);
		Movie[] movies = { alfie1, alfie2, gb1, gb2 };
		...
		Movie[] these = { alfie1, alfie1, alfie1, gb1, gb2, fclub };
		Movie[] those = { alfie1, alfie2, gb1,     gb2, gb1, gb2 };
	...
	private static void checkListArchiveFunctionality()
	{
		...
		uut.add(alfie1);
		uut.add(gb1);
		boolean sbFalse = uut.add(alfie2);
		String s = "Added Alfie (1966), then Ghostbusters (1984), then Alfie (1966)";
